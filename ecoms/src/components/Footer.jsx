...
const Footer = () => {
  return (
    <footer className='bg-gray-800 text-white py-8 px-4 md:pd-16 lg:pz-24'>
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
          <div>
            <h3 className='text-xl font-semibold'>Tech Stars</h3>
            <p className='mt-4'>
              Come to Us.
            </p>
          </div>
      ...
      <div className='mt-8 border-t border-gray-700 pt-4'>
        <div className='container mx-auto flex flex-col md:flex-row justify-between items-center'>
          <p>&copy; 2025 Tech Star All Rights reserved.</p>
